...
import com.fabienit.aeroclubspassion.config.AsyncSyncConfiguration;
import com.fabienit.aeroclubspassion.config.EmbeddedSQL;
...
@SpringBootTest(classes = { AeroclubspassionApp.class, AsyncSyncConfiguration.class })
@EmbeddedSQL
