...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.fabienit.aeroclubspassion.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.fabienit.aeroclubspassion.security.DomainUserDetailsService", "createSpringSecurityUser");
