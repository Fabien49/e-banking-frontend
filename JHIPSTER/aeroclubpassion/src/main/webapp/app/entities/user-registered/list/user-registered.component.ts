...
export class UserRegisteredComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.userRegisteredService
      ...
      .subscribe(
        (res: HttpResponse<IUserRegistered[]>) => {
  ...
  protected onSuccess(data: IUserRegistered[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
