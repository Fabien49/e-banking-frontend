...
describe('Aeroclub Management Component', () => {
  let comp: AeroclubComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(AeroclubComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.aeroclubs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
