package com.fabienit.aeroclubpassion.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.fabienit.aeroclubpassion.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.fabienit.aeroclubpassion.repository.UserRepository.USERS_BY_EMAIL_CACHE);
